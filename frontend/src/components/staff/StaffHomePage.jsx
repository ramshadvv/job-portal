            ...
            <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={4} lg={3} sx={{marginBottom:'2rem'}}>
                  ...
                  >
                  <Deposits title={'Applications'} values={22} dateupdate={'on 15 March, 2019'} />
                  </Paper>
                </Grid>
                {/* Recent Deposits */}
                <Grid item xs={12} md={4} lg={3} sx={{marginBottom:'2rem'}}>
                  ...
                  >
                  <Deposits title={'Accepted'} values={15} dateupdate={'on 15 March, 2019'} />
                  </Paper>
                </Grid>
                {/* Recent Deposits */}
                <Grid item xs={12} md={4} lg={3} sx={{marginBottom:'2rem'}}>
                  ...
                  >
                  <Deposits title={'Rejected'} values={7} dateupdate={'on 15 March, 2019'} />
                  </Paper>
                </Grid>
              </Grid>
              <Grid container spacing={3}>
