...
function OwnerProfile() {
    ...
    const {ownerToken, owner} = useContext(AuthContext)
    ...
    const fetchCompanyDetails = async(ownerToken) =>{
        setLoading(true)
    ...
    useEffect(()=> {
        fetchCompanyDetails(ownerToken)
    }, [ownerToken])
                    ...
                    <Card id='personal' sx={{ maxWidth: 900, marginLeft:'3rem', marginBottom:'5rem', marginTop:'3rem' }}>
                        <CardContent>
                            ...
                            <List>
                                <ListItem>
                                <ListItemText
                                    primary={owner.first_name + ' ' + owner.last_name}
                                />
                                </ListItem>
                                <Typography variant="body2" color="text.secondary" sx={{marginLeft:'1rem', fontSize:'1rem'}}>
                                    {owner.email}
