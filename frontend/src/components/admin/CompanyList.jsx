...
function CompanyList() {
  ...
  const handleBlock = (id, name, active) => {
    if (active === true) setUserStatus("block");
    else setUserStatus("Unblock");
    setUserId(id);
    setUserName(name);
  };
              ...
              <Table sx={{ minWidth: 700 }} aria-label="customized table">
                    ...
                    return (
                      <StyledTableRow key={row.id}>
                        ...
                        <StyledTableCell align="right">
                          {row.is_active === false ? (
                            <BlockIcon
                              sx={{ color: "#4f4fde", cursor: "pointer" }}
                              onClick={() => {
                                handleOpen();
                                handleBlock(
                                  row.id,
                ...
                >
                  <Box sx={style}>
                    ...
                    >
                      Do you want to{" "}
                      {userStatus === "delete" ? "Delete" : userStatus}{" "}
